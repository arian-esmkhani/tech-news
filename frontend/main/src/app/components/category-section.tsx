...
const groups = [
   { id: 1, title: "OperatingSystem", img: "/Survival.jpg" },
   { id: 2, title: "ProgrammingLanguage", img: "/Survival.jpg" },
   { id: 3, title: "JobPositions", img: "/Survival.jpg" },
   { id: 4, title: "Ai", img: "/Survival.jpg" },
];
